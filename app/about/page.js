export const metadata = {
  title: "About Us — BestDaam",
  description:
    "BestDaam is an Indian price comparison website that helps you find the lowest price across Amazon, Flipkart, Croma and Reliance Digital.",
};

export default function AboutPage() {
  return (
    <article className="content-page">
      <h1>About BestDaam</h1>
      <p>
        <strong>BestDaam.in</strong> is an Indian price comparison website. Our
        mission is simple: help you find the <em>best daam</em> (best price)
      ...
      <p>
        ...
        pay the store&apos;s own price. BestDaam may earn a small affiliate
