...
export default function PrivacyPage() {
  return (
    <article className="content-page">
      ...
      <ul>
        <li>
          <strong>Nothing personal by default.</strong> You can browse and
          compare prices without creating an account or giving us any personal
          information.
        </li>
        <li>
          <strong>Basic usage data.</strong> Like most websites, our hosting
          provider may log anonymous technical data (browser type, pages
          visited) to keep the site fast and secure.
        </li>
      </ul>
